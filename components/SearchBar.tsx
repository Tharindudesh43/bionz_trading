...
export default function SearchBar() {
  ...
  return (
    <div className=" flex w-[40%] items-center justify-between relative">
      <input
        type="search"
        className="relative block w-[100%] min-w-0 flex-auto  border border-solid border-[#f59e0b] bg-transparent bg-clip-padding px-3 py-[0.25rem] font-normal leading-[1.6]  outline-none transition duration-200 ease-in-out"
        placeholder="Search"
        aria-label="Search"
      ...
      <button
        type="button"
        aria-label="Search"
        className="input-group-text flex items-center cursor-pointer  px-3 py-2 text-center font-normal text-white bg-[#f59e0b]"
        id="basic-addon2"
