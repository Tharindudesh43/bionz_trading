...
export default function Analyze() {
  ...
  // const analyzeData: AnalyzeProps[] = [
  //   {
  //     analyze_id: "1",
  //     analyze_image: "https://media.istockphoto.com/id/155418768/photo/female-business-hands-working-on-table.jpg?s=612x612&w=is&k=20&c=wG17dQ8Ey4T-AhnlNMXJVC04qgASLXhRtRclvFlWWMU=",
  //     created_date: Timestamp.now(),
  //     analyze_description: "This is a description for analyze 1.", 
  //     pair: "BTC/USD",
  //     type: "futures"
  //   },
  //    {
  ...
  <button
    ...
    className={`px-3 py-1.5 ${filter === "ALL" ? "text-amber-700" : "text-black"} hover:text-amber-700 rounded-full text-sm font-medium transition-shadow cursor-pointer`}
  >
    ALL
  </button>
  ...
  <button
    ...
    className={`px-3 py-1.5 ${filter === "Spot" ? "text-amber-700" : "text-black"} hover:text-amber-700 rounded-full text-sm font-medium transition-shadow cursor-pointer`}
  >
    Spot
  </button>
  ...
  <button
    ...
    className={`px-3 py-1.5 ${filter === "Futures" ? "text-amber-700" : "text-black"} hover:text-amber-700 rounded-full text-sm font-medium transition-shadow cursor-pointer`}
  >
    Futures
  </button>
</div>
