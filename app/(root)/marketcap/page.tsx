...
export default function Home() {
 ...
 return (
  <div className="relative w-full">
    ...
    <div className="fixed w-full bg-[#FBFBFB] z-30 shadow-sm right-0 top-14 sm:top-19 md:top-19 lg:top-17">
      <div className="flex items-center justify-start px-3 py-7">
        <SearchBar />
      </div>
    </div>
